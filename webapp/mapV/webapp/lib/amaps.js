        ...
        (function(a, b) {
                ...
                if (f)
                    try {
                        ...
                        if (l && "1575858593887" === l.version)
                            config.vD = !0,
                                eval(l.script);
                        else
                            throw e(),
                                Error("localStorage's version is " + l.version + ", but the latest version is 1575858593887");
                    } catch (m) {
                        d()
                    }
                else
...
)(["608d75903d29ad471362f8c58c550daf", [118.344933, 29.188757, 120.721945, 30.566516, 120.153576, 30.287459], "https://webapi.amap.com", 1, "1.4.15", null, "330100", "", true, false, false, true, "1575983942-20191218-1", false])
